...
class VoyageDeplacementType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
             ...
             * ========================= */
            ->add('latDepartAller', HiddenType::class, ['mapped' => false])
            ->add('lonDepartAller', HiddenType::class, ['mapped' => false])
            ->add('latArriveeAller', HiddenType::class, ['mapped' => false])
            ->add('lonArriveeAller', HiddenType::class, ['mapped' => false])
            
            ->add('latDepartRetour', HiddenType::class, ['mapped' => false])
            ->add('lonDepartRetour', HiddenType::class, ['mapped' => false])
            ->add('latArriveeRetour', HiddenType::class, ['mapped' => false])
            ->add('lonArriveeRetour', HiddenType::class, ['mapped' => false])
